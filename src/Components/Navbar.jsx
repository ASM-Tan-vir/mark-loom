    ...
    <div className="flex items-center justify-between py-5 font-medium">
      ...
      <div className="flex items-center gap-6">
        ...
        <Link to="/cart" className="relative">
          ...
          <p className="absolute right-[-3px] bottom-[-3px] w-5 text-center leading-5 bg-black text-white aspect-square rounded-full text-[5px]">
            10
          </p>
        </Link>
        <img
      ...
      {/* side bar menu icon for mobile screen */}
      <div
